    ...
    <div className="md:flex gap-10 justify-center">
      ...
      <div className="md:w-1/2">
        <div>
          ...
          <p className="text-xl font-bold text-gray-600">{product?.price} <span className="text-xs text-green-500">- IN STOCK</span>
          </p>
          <p className="my-5 text-sm text-gray-600 leading-6">{product?.description}</p>
