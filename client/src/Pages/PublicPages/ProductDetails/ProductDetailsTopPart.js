...
import { FaArrowAltCircleRight, FaMinusCircle, FaPlusCircle, FaStar } from 'react-icons/fa';

const ProductDetailsTopPart = ({meals}) => {
        ...
        <div className="md:flex gap-10 justify-center">
            {
                ...
                <>
                    ...
                    <div className="md:w-1/2">
                        <div>
                            <h1 className="text-xl md:text-2xl font-semibold mt-2 md:mt-0"> {meal.strMeal}</h1>
                            ...
                            <p className="my-5 text-sm text-gray-600 leading-6">{meal.strInstructions.slice(0, 150)} </p>
