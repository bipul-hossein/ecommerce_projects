...
const CartDetails = () => {
  ...
  return (
    <div className="min-h-screen md:pl-2">
      ...
      <div className="mt-5 md:my-7 flex md:gap-2 flex-wrap md:flex-nowrap mx-auto bg-slate-50 ">
        <div className="w-full md:w-auto px-3 md:px-5 pb-10 md:pb-14 pt-4 md:pt-7 md:border-b-2 md:mb-3 md:rounded-none md:border-[1px]">
        ...
        <div className="w-full md:px-4 md:w-[350px] h-auto mx-auto pt-4 md:pt-7 md:border-y-2 pb-3 md:rounded-none md:border-[1px]">
          <table className="w-full">
            ...
            <tbody>
              ...
              <tr className="border-t-[1px]">
                <td className="px-3 pt-5">Shipping</td>
              </tr>
              <tr>
